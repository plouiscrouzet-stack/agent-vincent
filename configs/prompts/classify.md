...
- **MEETING_CONFIRMED** : Le prospect accepte un échange et propose/confirme un créneau OU demande les disponibilités d'Eric ("je vous laisse me dire vos disponibilités", "quand êtes-vous disponible", "proposez-moi un créneau")
...
- Si le prospect confirme une date/heure spécifique OU demande les disponibilités d'Eric → `MEETING_CONFIRMED`
...
- Si le message cite ou reprend le contenu de l'email d'Eric (mots spécifiques, chiffres, proposition), c'est une réponse humaine, PAS un `AUTO_REPLY`
